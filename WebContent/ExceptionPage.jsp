			...
			<div class="col-md-4">
				<div class="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">EXCEPTION PAGE</li>
					</ol>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-offset-1 col-md-10 text-center">
				...
				<h1>Sorry for the inconvenience - The Page you are looking for
					have Technical Error.</h1>

				<h3>Kindly proceed to Home Page or Report this issue to Web
					Administrator with the Description mentioned below.</h3>

				<br /> <a href="index.jsp" class="btn btn-default btn-green"><span
					class="glyphicon glyphicon-home"></span>&nbsp;HOME</a> <a href="report"
					class="btn btn-default btn-green"><span class="fa fa-bug"></span>&nbsp;REPORT</a>
				<br />
				<br />
